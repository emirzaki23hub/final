      ...
      <CRow>
        <CCol xs="12">
          <CFade timeout={300} in={showElements} unmountOnExit={true}>
            <CCard>
              <CCardHeader>
                <h4> Form Pelaporan Pengaduan  </h4>
              </CCardHeader>
              <CCollapse show={collapsed} timeout={1000}>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CSelect custom name="select" id="select"  {...register("NoPengaduan",{required:'true'})}>
                    <option value=""disabled selected hidden>Silahkan Pilih Nomor Pengaduan</option>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput type="date" id="date-input" name="date-input" placeholder="date"  {...register("Tanggal Pengaduan",{required:'true'})}/>
                  </CCol>
                </CFormGroup>
                  ...
                  <CCol xs="10" md="9">
                    ...
                    required
                      ...
                      id="textarea-input" 
                      rows="3"
                      placeholder="Deskripsi Pelaporan Pengaduan..." 
